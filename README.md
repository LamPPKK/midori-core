...
web engines. This repository contains the Linux desktop browser and the small,
single-tab Android edition, Xanh Browser Lite.

> **Release status:** 1.0.0 is a release candidate. Local build and unit-test
> lanes pass, but production artifacts must not be published until the signed
> artifact, Linux, Flatpak, device-matrix, security-scan and store gates in
...
- GLib 2.74+
- GTK 4.10+
- WebKitGTK 6.0 and JavaScriptCoreGTK 6.0, version 2.52+
...
| `.github/workflows/` | Linux, Android, instrumentation, Flatpak, CodeQL and source-release CI |
...
Xanh Browser 1.0 targets Linux desktop and Android API 26–36. Windows, macOS,
Android legacy-data import and Manifest V3 are intentionally outside this
release.
